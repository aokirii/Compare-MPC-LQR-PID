...
% CANLI ANIMASYON + VERI KAYDEDICI (Discrete LQR) - tek kaynak.
% Yorungeyi cizer VE t,x,y,theta,delta,ey,eh,s sinyallerini base'e
% 'sim_log_LQR' adiyla yazar.
%
...
if isempty(initialized)
    ...
    title('Discrete LQR Live Tracking'); xlabel('x'); ylabel('y');
...
if mod(k, 25) == 0
    ...
    S.meta = struct('ctrl','LQR','Ts',Ts,'nRef',nRef,'sEnd',sEnd,'v',vlog);
    assignin('base', 'sim_log_LQR', S);
end
